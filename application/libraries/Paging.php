...
class Paging 
{
	...
	{
		$html = '<li class="page-item"><a href="'.$this->get_pagenum_link($counter).'" class="page-link">'.$counter.'</a></li>';
	...
	{
		$html = '<li class="page-item active"><a class="page-link">'.$counter.'</a></li>';
	...
	{
		$n = '<span aria-hidden="true"><span class="lnr lnr-chevron-right"></span></span>';
		
		if(!empty($counter))
			$html = '<li class="page-item"><a href="'.$this->get_pagenum_link($counter).'" class="page-link" aria-label="Previous">'.$n.'</a></li>';
		else
			$html = '<li class="page-item"><a class="page-link" aria-label="Previous">'.$n.'</a></li>';
	...
	{
		$p = '<span aria-hidden="true"><span class="lnr lnr-chevron-left"></span></span>';
		
		if(!empty($counter))
			$html = '<li class="page-item"><a href="'.$this->get_pagenum_link($counter).'" class="page-link" aria-label="Previous">'.$p.'</a></li>';
		else
			$html = '<li class="page-item"><a class="page-link" aria-label="Previous">'.$p.'</a></li>';
	...
	function html_show()
	{
		...
		$html = '<nav class="blog-pagination justify-content-center d-flex"><ul class="pagination">'.$this->pagination.'</u></nav>';
