					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-9">
							<div class="title text-center">
								...
								<p>Popular places in the Bandung Raya area.</p>
							</div>
						</div>
					</div>							
					<div class="row">
						...
						if(isset($popular[$col]) && !empty($popular[$col])) {
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="img-fluid" src="assets/traveltemplate/img/d3.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
											<li>
												<a href="<?= y_url_cat($b->cat_id, $b->cat_url) ?>"><?= $b->cat_name ?></a>
											</li>										
										</ul>
									</div>
									<a href="<?= y_url_read($b->post_id, $b->post_url) ?>" title="<?= $b->post_title_id ?>"><h4 class="title"><?= $b->post_title_id ?></h4></a>
									<p>
									<?= !empty($b->post_excerpt_id) ? y_ellipsis($b->post_excerpt_id, 70) : y_ellipsis($b->post_content_id, 70) ?> [..]
                                    </p>
									<h6 class="date"><?= y_date_text($b->post_date) ?></h6>
								</div>	
							</div>
                        <?php 
                            } }
