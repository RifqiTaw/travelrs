...
class Recommender extends CI_Controller
{
	...
	public function index()
	{
		...
		//// coba memanggil dari database
		// $data['wakunwis'] = $this->Ms_Category_Model->get_waktu_kunjungan()->result();
	...
	public function step2()
	{
		...
		// $data['visitingTime'] = $this->Common_Model->form_visitingTime();

		// $data['visitingTime'] = $this->dm->form_visitingTime();
	...
	// public function get_wakun()
	// {
	// 	$data['arrive'] = $this->Ms_Category_Model->get_wakunwis();
	// }


/////////// ------------ nyoba -----------\\\\\\\\\\\\
	// public waktu_kunjungan($id)
	// {
	// 	$data = $this->Ms_Category_Model->get_waktu_kunjungan($id);
	// }
...
///////// ----------------------------------\\\\\\\\\\\\
	...
	public function result()
	{
		...
		// $visitingTime = $this->input->get('visitingTime');
		$error		= false;
		$etext		= '';
		...
		if(empty($visitingTime)) $visitingTime = 3600;
		...
		if(!$error)
		{
			...
			// $param['visitingTime'][] = (int)$visitingTime;
		...
		$this->load->view('frontend/tpl_rec_result', $data);
	}
	...
	public function get_destination()
	{
		...
		//###################################################//
		// $all_wk = $this->Ms_Category_Model->get_all_wakunwis();
		// $wk_id = $this->Ms_Category_Model->get_wakunwis($id);
		//##################################################//
	...
	// public function wakunwis()
	// {
	// $wakunwis = $this->Ms_Category_Model->get_waktu_kunjungan($id)->result();
	// }
